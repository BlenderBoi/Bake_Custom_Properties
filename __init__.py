...
bl_info = {
    "name": "Bake Custom Properties",
    "author": "BlenderBoi",
    "version": (1, 0, 0),
    "blender": (3, 00, 0),
    "description": "Keyframe Custom Properties for Object, Object Data or Bone",
    "warning": "",
    "category": "Animation",
    "location": "Object > Animation > Bake Custom Properties",
}
...
class BCP_Bake_Custom_Properties(bpy.types.Operator):
    """Bake Custom Properties"""
    bl_idname = "bcp.bake_custom_properties"
...
def draw_item(self, context):
    layout = self.layout
    layout.operator("bcp.bake_custom_properties", text="Bake Custom Properties")

classes = [BCP_Bake_Custom_Properties]

def register():
    for cls in classes:
        bpy.utils.register_class(cls)
    
    bpy.types.VIEW3D_MT_object_animation.append(draw_item)

def unregister():
    for cls in classes:
        bpy.utils.unregister_class(cls)

    bpy.types.VIEW3D_MT_object_animation.remove(draw_item)
